...
void main()
{
    ...
    vec4 aim3[3][] = {vec4[2](vec4(4.0), vec4(2.0)),
                      vec4[2](vec4(4.0), vec4(2.0)),
                      vec4[2](vec4(4.0), vec4(2.0)) };
    vec4 bad2[3][] = {vec4[2](vec4(4.0), vec4(2.0)),
                      vec4[3](vec4(4.0), vec4(2.0), vec4(5.0)),
                      vec4[2](vec4(4.0), vec4(2.0)) };
    vec4 bad3[3][] = {vec4[3](vec4(4.0), vec4(2.0), vec4(5.0)),
                      vec4[2](vec4(4.0), vec4(2.0)),
                      vec4[2](vec4(4.0), vec4(2.0)) };
    vec4 bad4[4][] = {vec4[2](vec4(4.0), vec4(2.0)),
                      vec4[2](vec4(4.0), vec4(2.0)),
                      vec4[2](vec4(4.0), vec4(2.0)) };
    g4 = foo(g5);
    g5 = g4;
