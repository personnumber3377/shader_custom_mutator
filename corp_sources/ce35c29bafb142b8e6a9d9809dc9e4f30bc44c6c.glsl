...
vec4 gtf_Vertex = vec4((false ? -(false ? -1.0 : -1.0) : 0.0), 0.0, +((false || false) ? (false ? 0.0 : 1.0) : (false ? 0.5 : -1.0)), 2.0);

vec4 gtf_Color = vec4((false ? 1.0 : (0.0 - 0.5)), 0.0, (false ? (0.5 + 0.5) : 1.0), +((false ? 1.0 : 2.0) + 1.0));
