...
vec4 gtf_Color = vec4(-1.0, +(false ? (false ? 0.5 : 1.0) : (false ? 1.0 : 1.0)), +-(2.0 - 2.0), (((false ? true : false) ? true : (false ? false : false)) ? -1.0 : ((true ? 0.0 : 1.0) - (true ? 0.0 : -1.0))));

vec4 gtf_Vertex = vec4(((false || (true ? true : false)) ? 2.0 : -1.0), 2.0, 0.0, 2.0);
